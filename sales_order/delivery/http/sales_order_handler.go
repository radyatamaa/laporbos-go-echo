...
type SalesOrderHandler struct {
	SalesOrderUsecase sales_order.Usecase
}

func NewSalesOrderHandler(e *echo.Echo, us sales_order.Usecase) {
	handler := &SalesOrderHandler{
		SalesOrderUsecase: us,
	}
...
func (a *SalesOrderHandler) GetAllSalesOrder(c echo.Context) error {
	...
	art, err := a.SalesOrderUsecase.GetAll(ctx, page, limit, offset)
	if err != nil {
...
func (a *SalesOrderHandler) ImportSalesOrder(c echo.Context) error {
	...
	error := a.SalesOrderUsecase.Import(ctx, imagePath)
